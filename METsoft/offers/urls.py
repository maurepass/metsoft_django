...
urlpatterns = [
    ...
    path(
        "",
        TemplateView.as_view(template_name="offers/index_offers.html"),
        name="offers",
    ),
    ...
    path(
        "<int:pk>/details/create/",
        views.DetailCreateView.as_view(),
        name="detail-create",
    ),
    path(
        "<int:pk>/details/<int:det_pk>/update/",
        views.DetailUpdateView.as_view(),
        name="detail-update",
    ),
    path(
        "<int:pk>/details/<int:det_pk>/delete/",
        views.DetailDeleteView.as_view(),
        name="detail-delete",
    ),
    path(
        "details/",
        TemplateView.as_view(template_name="offers/details_index.html"),
        name="details-index",
    ),
    path(
        "details/searching/",
        views.DetailSearchingView.as_view(),
        name="details-searching",
    ),
    path(
        "materials/",
        TemplateView.as_view(template_name="offers/material_list.html"),
        name="materials",
    ),
    path(
