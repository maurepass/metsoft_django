...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='pattern',
            name='status',
            field=models.ForeignKey(default=1, limit_choices_to={'pk__lt': 8}, null=True, on_delete=django.db.models.deletion.SET_NULL, to='patterns.PatternStatus', verbose_name='status'),
        ),
    ]
