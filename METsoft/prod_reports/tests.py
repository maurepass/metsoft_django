...
class ProdReportsTest(TestCase):
    ...
    #     response = self.client.get(reverse('weight-per-client'))
    #     self.assertEqual(response.status_code, 200)

    # def test_url_weight_per_group(self):
    #     response = self.client.get(reverse('weight-per-group'))
    #     self.assertEqual(response.status_code, 200)
    #
    # def test_url_scraps(self):
    #     response = self.client.get(reverse('scraps'))
    #     self.assertEqual(response.status_code, 200)
    ...
    #     response = self.client.get(reverse('monitoring-in-work'))
    #     self.assertEqual(response.status_code, 200)

    # def test_url_monitoring_all(self):
    #     response = self.client.get(reverse('monitoring-all'))
    #     self.assertEqual(response.status_code, 200)
    ...
    #     response = self.client.get(reverse('inserted-data'))
    #     self.assertEqual(response.status_code, 200)
